...
export default function TdActions({ showUserInfo, isEdited, showEditVew, closeWindow }) {
    

    return (
        <td className="actions">
            <button className="btn edit-btn" title="Edit" onClick={showEditVew}>
            ...
            {isEdited && <AddUserView viewName={'Add User'} closeWindow={closeWindow} />}
        </td>
    );
}