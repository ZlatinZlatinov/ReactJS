// Ig u want to test it, just replace the code from here in the app.js
  ...
  return (
    <>
      ...
      <form onSubmit={submitFormHandler}>
        ...
        <br></br>
        <input type="text" name="username" id="username" value={username} onChange={usernameHandler}></input>
        <br></br>
        <label htmlFor="age">Age:</label>
        <br></br>
        <input type="number" name="age" id="age" value={age} onChange={ageHandler}></input>
        {Number(age) > 18 && <p>You are over 18 years old now!</p>} {/*So this could be some kind of validation i guess */}
        <br></br>
        ...
        <br></br>
        <textarea name="description" cols="15" rows="5" value={description} onChange={desctioptionHandler}></textarea>
